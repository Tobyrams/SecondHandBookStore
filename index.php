...
<body>
    ...
    <div class="container">
        <h1 class="heading heading1 h">Booktrekker</h1>
        <h1 class="heading heading2 h">Booktrekker</h1>
        <h1 class="heading heading3 h">Booktrekker</h1>
        <h1 class="heading heading4 h">Booktrekker</h1>
        <h1 class="heading heading5 h">Booktrekker</h1>
        <h1 class="heading heading6 h">Booktrekker</h1>
